        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        events = _a.sent();
                        return [2 /*return*/, res.status(200).json({ events: events })];
                    case 2:
                        err_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Event_1.default.findById(req.params.id)];
                    case 1:
                        event_1 = _a.sent();
                        if (event_1) {
                            return [2 /*return*/, res.status(200).json({ event: event_1 })];
                        }
                        else {
